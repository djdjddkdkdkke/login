...
$accounts = [
    "RetiredGamer" => ["password" => "ALIBN123", "expires" => "2025-12-31 23:59:59"],
    "FreeUser"     => ["password" => "ALIBN123",   "expires" => "2024-12-31 00:00:00"],
    "BetaTest"     => ["password" => "ALIBN123",     "expires" => "2025-07-15 12:00:00"]
];
